...
```bash
DBEV_VERSION=v0.7.1 # replace with the reviewed release
case "$(uname -m)" in
...
```bash
export DBEV_IMAGE='ghcr.io/tomaxikz/databaseseverywhere:v0.7.1@sha256:REPLACE_ME'
docker compose up -d
```
