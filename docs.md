...
The musl builds are static and run anywhere; glibc (`-gnu`) builds are also published if you prefer them. Each tarball ships with a `.sha256` file if you want to verify the download.
