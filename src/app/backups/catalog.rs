...
use crate::{
    config::BackupBrowsingConfig,
    instances::credentials::logical_export_env,
    instances::metadata::InstanceMetadata,
    placement::DeploymentMode,
    runtime::docker::DockerRuntime,
    shared::{hex::nibble, protocol::Protocol, shell::sh_quote},
};
    ...
    match metadata.protocol {
        ...
        Protocol::Mariadb => {
            let output = run_query(
                docker,
                metadata,
                &mysql_schema_script(false, false, max_objects),
            )
            .await?;
...
fn mysql_schema_script(mysql: bool, shared: bool, max_objects: usize) -> String {
...
fn mongodb_schema_script(shared: bool, max_objects: usize) -> String {
...
fn preview_script(
    ...
    match metadata.protocol {
        ...
        Protocol::Mariadb | Protocol::Mysql => {
            ...
            let command = if metadata.protocol == Protocol::Mysql {
