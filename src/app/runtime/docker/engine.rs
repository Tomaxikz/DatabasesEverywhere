...
pub(super) const MINIMUM_PODMAN_VERSION: &str = "4.3.0";
...
pub(super) fn is_rootless_podman_socket(path: &Path) -> bool {
...
pub(super) fn reports_podman(version: &SystemVersion) -> bool {
...
pub(super) fn is_supported_podman_version(version: &str) -> bool {
...
pub(super) fn podman_socket_owner(path: &str) -> std::io::Result<HostOwner> {
