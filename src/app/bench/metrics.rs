...
pub(super) struct BenchmarkOptionsReport {
...
#[derive(Debug, Clone, Serialize)]
pub(super) struct TargetInstanceReport {
...
impl LatencySummary {
    pub(super) fn from_micros(values: &[u64]) -> Option<Self> {
        if values.is_empty() {
            return None;
        }
    ...
    pub(super) fn from_histogram(histogram: &Histogram<u64>) -> Option<Self> {
...
#[derive(Debug, Clone, Serialize)]
pub(super) struct HttpPhaseReport {
    pub name: String,
...
#[derive(Debug, Clone, Serialize)]
pub(super) struct WebSocketBenchmarkReport {
    pub token_mint: HttpPhaseReport,
    pub handshake: HttpPhaseReport,
}

#[derive(Debug, Clone, Serialize)]
pub(super) struct JobBenchmarkReport {
    pub action: String,
...
#[derive(Debug, Clone, Serialize)]
pub(super) struct ManualActiveJobsRecommendationReport {
    pub method: String,
    pub status: String,
...
pub(super) struct SchedulerCapacityReport {
    pub mode: String,
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub(super) struct SchedulerJobCostReport {
...
#[derive(Debug, Clone, Serialize)]
pub(super) struct ManualActiveJobsWorkloadReport {
    pub workload: String,
    pub protocol: String,
    pub mode: String,
    pub compressed: bool,
...
pub(super) struct InstanceResourcePeak {
    pub protocol: String,
