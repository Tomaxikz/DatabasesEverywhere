...
#[derive(Debug, Clone)]
pub(super) struct InstanceSampleTarget {
...
impl ResourceSampler {
    ...
    pub(super) fn set_phase(&self, phase: impl Into<String>) {
        self.control
            .send_modify(|control| control.phase = phase.into());
    }

    pub(super) async fn finish(self) -> (ResourceSummary, Vec<ResourceSample>, Vec<String>) {
