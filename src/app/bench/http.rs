...
impl BenchClient {
    ...
    pub(super) async fn benchmark_sequential(&self, count: usize) -> PhaseRun {
    ...
    pub(super) async fn benchmark_concurrent(
        &self,
        count: usize,
        concurrency: usize,
    ...
    pub(super) async fn benchmark_websockets(
        &self,
        count: usize,
        concurrency: usize,
        benchmark_id: &str,
    ...
    pub(super) async fn benchmark_import_export(
        &self,
        instance_id: &str,
        timeout: Duration,
        keep_artifact: bool,
